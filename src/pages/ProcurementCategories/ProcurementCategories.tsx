...
} from "@/services/store/procurementCategorie/procurementCategorie.thunk";
  ...
  const buttons: IGridButton[] = [
    {
      ...
      //   permission: EPermissions.DETAIL_PROCUREMENT_CATEGORY,
    },
    {
      type: EButtonTypes.UPDATE,
      // permission: EPermissions.UPDATE_PROCUREMENT_CATEGORY,
    },
    {
      ...
      // permission: EPermissions.DESTROY_PROCUREMENT_CATEGORY,
    },
  ];
