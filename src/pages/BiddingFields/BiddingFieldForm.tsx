...
import { createBiddingField, updateBiddingField } from "@/services/store/biddingField/biddingField.thunk";
...
interface IBiddingFieldFormProps {
    formikRef?: FormikRefType<IBiddingFieldFormInitialValues>;
...
const BiddingFieldForm = ({ formikRef, type, biddingField }: IBiddingFieldFormProps) => {
    ...
    const validationSchema = object().shape({
        name: string().required("Please enter the bidding field name"),
        description: string().required("Please enter the bidding field description"),
        code: number().required("Please enter a code"),
    });

    useEffect(() => {
        const options = state.biddingFields.map(field => ({
    ...
    return (
        <Formik
            innerRef={formikRef}
            initialValues={biddingField ?? initialValues}
