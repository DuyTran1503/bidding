...
import { SchemaBidDocument } from "@/shared/Schema/schema";
...
const BidDocumentForm = ({ formikRef, type, bidDocument, project_id, isCreateFromProject }: IBidDocumentFormProps) => {
  ...
  return (
    <Formik
      ...
      validationSchema={SchemaBidDocument}
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} sm={24} md={12} xl={12}>
                <FormGroup title="Giá đề nghị" required>
                  <FormNumber
                    ...
                    error={touched.bid_price || !values.bid_price ? errors.bid_price : ""}
                    onChange={(e) => {
              ...
              <Col xs={24} sm={24} md={12} xl={8}>
                <FormGroup title="Thời gian thực hiện" required>
                  <FormDate
                    disabled={type === "view"}
                    error={touched.implementation_time || !values.implementation_time ? errors.implementation_time : ""}
