...
const FormCkFinder = forwardRef(function FormCkEditor(props: Props, ref?: ForwardedRef<any>) {
  ...
  const Error = () => errors && !!errors[id] && touched && touched[id] && <div className="d-block">{`${errors[id]}`}</div>;
...
export default memo(FormCkFinder);
